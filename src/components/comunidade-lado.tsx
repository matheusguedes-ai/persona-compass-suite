  ...
  return (
    <aside className="space-y-3">
      ...
      {/* O perfil do colega, com o que ELE autorizou. Quando não autorizou, os
          campos nem chegam aqui — o corte é no banco. Mesmo cartão que abre
          ao clicar numa menção com @ no feed (#55) — um componente só. */}
      <PerfilColegaDialog personId={vendo} onOpenChange={(v) => !v && setVendo(null)} />
    </aside>
  );
}
